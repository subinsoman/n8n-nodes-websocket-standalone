...
async function proxyRequestToAxios(workflow, additionalData, node, uriOrObject, options) {
    ...
    try {
        ...
        if (error.isAxiosError) {
            ...
            else if ('rejectUnauthorized' in configObject && ((_d = error.code) === null || _d === void 0 ? void 0 : _d.includes('CERT'))) {
...
async function getCredentials(workflow, node, type, additionalData, mode, runExecutionData, runIndex, connectionInputData, itemIndex) {
    ...
    const nodeCredentials = node.credentials
        ...
        : {};
    const decryptedDataObject = await additionalData.credentialsHelper.getDecrypted(additionalData, nodeCredentials, type, mode, additionalData.timezone, false, expressionResolveValues);
