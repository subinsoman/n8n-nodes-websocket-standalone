...
class Workflow {
    ...
    async createWebhookIfNotExists(webhookData, nodeExecuteFunctions, mode, activation, isTest) {
        const webhookExists = await this.runWebhookMethod('checkExists', webhookData, nodeExecuteFunctions, mode, activation, isTest);
        if (!webhookExists) {
            await this.runWebhookMethod('create', webhookData, nodeExecuteFunctions, mode, activation, isTest);
        }
    }
    async deleteWebhook(webhookData, nodeExecuteFunctions, mode, activation, isTest) {
        await this.runWebhookMethod('delete', webhookData, nodeExecuteFunctions, mode, activation, isTest);
    }
